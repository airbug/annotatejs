...
var DependencyGraph = Class.extend(Graph, {
    ...
    processDependentOrder: function(dependencyNode, processedNodeSet, scriptsInDependentOrderList) {
        var visitedNodeSet = new Set();
        this.processDependentOrderRecursive(dependencyNode, processedNodeSet, scriptsInDependentOrderList, visitedNodeSet);
    },
    ...
    processDependentOrderRecursive: function(dependencyNode, processedNodeSet, scriptsInDependentOrderList, visitedNodeSet) {
        ...
        if (!processedNodeSet.contains(dependencyNode)) {
            ...
            nodeFromSet.forEach(function(nodeFrom) {
                _this.processDependentOrderRecursive(nodeFrom, processedNodeSet, scriptsInDependentOrderList, visitedNodeSet);
            });
