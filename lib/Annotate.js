...
var ClientAnnotateCompiler = require('./compiler/ClientAnnotateCompiler');
 ...
 */
Annotate.compileClient = function(sourceHomePaths, outputPath, outputFileName) {
    ClientAnnotateCompiler.compile(sourceHomePaths, outputPath, outputFileName);
};
