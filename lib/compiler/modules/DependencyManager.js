...
var DependencyManager = Class.extend(EventDispatcher, {
    ...
    _constructor: function() {
        ...
        /**
         * @private
         * @type {Map<AnnotationSourceNode, ExportCode>}
         */
        this.exportAnnotationSourceNodeToExportCodeMap = new Map();

        /**
         * @private
         * @type {Map<AnnotationSourceNode, RequireCode>}
         */
        this.requireAnnotationSourceNodeToRequireCodeMap = new Map();
    },
    ...
    checkAddedExportCode: function(addedExportCode) {
    ...
    checkAddedRequireCode: function(addedRequireCode) {
    ...
    processAddedExportAnnotationSourceNode: function(addedExportAnnotationSourceNode) {
        ...
        this.exportAnnotationSourceNodeToExportCodeMap.put(addedExportAnnotationSourceNode, addedExportCode);
        this.addExportCode(addedExportCode);
        this.checkAddedExportCode(addedExportCode);
    },
    ...
    processAddedRequireAnnotationSourceNode: function(addedRequireAnnotationSourceNode) {
        ...
        this.requireAnnotationSourceNodeToRequireCodeMap.put(addedRequireAnnotationSourceNode, addedRequireCode);
        this.addRequireCode(addedRequireCode);
        this.checkAddedRequireCode(addedRequireCode);
    },
