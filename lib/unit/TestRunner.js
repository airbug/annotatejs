...
TestRunner.runTest = function(test, logResults) {
    ...
    var assertionResultHandler = function(event) {
    ...
    test.addEventListener(Test.EventTypes.ASSERTION_RESULT, assertionResultHandler);
    try {
        if (logResults) {
    ...
    test.removeEventListener(Test.EventTypes.ASSERTION_RESULT, assertionResultHandler);
    return testResult;
};
