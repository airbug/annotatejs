...
var DocumentNode = Class.extend(EventDispatcher, {
    ...
    addChildNode: function(childNode) {
        ...
        this.updateChildNodesDocument(childNode);
        childNode.dispatchEvent(new Event(DocumentNode.EventType.NODE_ADDED));
    },
    ...
    removeChildNode: function(childNode) {
        if (this.containsChildNode(childNode)) {
            childNode.dispatchEvent(new Event(DocumentNode.EventType.NODE_REMOVED));
