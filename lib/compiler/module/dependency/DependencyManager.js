...
var DependencyManager = Class.extend(EventDispatcher, {
    ...
    initialize: function(compiler) {
        ...
        this.application.addEventListener(Application.EventType.SCRIPT_ADDED,
            this.hearApplicationScriptAddedEvent, this);
        this.application.addEventListener(Application.EventType.SCRIPT_REMOVED,
            this.hearApplicationScriptRemovedEvent, this);
        compiler.addEventListener(Compiler.EventType.PROCESS_CHANGE_LIST_COMPLETE,
    ...
    addExportCode: function(exportCode) {
        ...
        if (!this.checkExportCodeForNamingErrors(exportCode) && !this.checkExportCodeForDuplicateErrors(exportCode)) {
     ...
     * @return {boolean}
     */
    checkExportCodeForDuplicateErrors: function(exportCode) {
        return false;
    },
    ...
    dispatchDependenciesUpdated: function() {
        this.dispatchEvent(new Event(DependencyManager.EventType.DEPENDENCIES_UPDATED));
    },
