...
var AddScriptChange = require('./changes/AddScriptChange');
var Application = require('./Application');
var ChangeList = require('./changes/ChangeList');
...
var Compiler = Class.extend(EventDispatcher, {
    ...
    // NOTE BRN: Changes in the ChangeList should be based around the SourceTree/Scripts and not the the token list or
    // CharacterList. This will allow the compiler to deal with valid changes to the SourceTree and the Parser to deal
    // with changes to the character and token lists. The Parser would then shuttle PubSub messages over to the Compiler
    // describing the changes to the SourceTree.
