...
var ScriptMonitor = Class.extend(AlertMonitor, {
    ...
    _constructor: function(script) {
        ...
        script.addEventListener(DocumentNode.EventTypes.NODE_ADDED, this.hearNodeAddedEvent, this);
        script.addEventListener(DocumentNode.EventTypes.NODE_REMOVED, this.hearNodeRemovedEvent, this);
    },
